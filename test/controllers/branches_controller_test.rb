...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { name: @branch.name, phone: @branch.phone, postalcode: @branch.postalcode, streetaddress: @branch.streetaddress }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { name: @branch.name, phone: @branch.phone, postalcode: @branch.postalcode, streetaddress: @branch.streetaddress }
    assert_redirected_to branch_path(assigns(:branch))
  end
