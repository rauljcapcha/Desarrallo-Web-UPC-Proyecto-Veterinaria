...
class GuidesControllerTest < ActionController::TestCase
  ...
  test "should create guide" do
    assert_difference('Guide.count') do
      post :create, guide: { atention_id: @guide.atention_id, service_id: @guide.service_id, total: @guide.total }
    end
  ...
  test "should update guide" do
    patch :update, id: @guide, guide: { atention_id: @guide.atention_id, service_id: @guide.service_id, total: @guide.total }
    assert_redirected_to guide_path(assigns(:guide))
  end
